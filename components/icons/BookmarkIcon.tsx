const BookmarkIcon = ({ isFilled = false, fillColor = "#01BD82", size = 20, stroke = "#A3A3A3", strokeWidth = 1.8 }: { isFilled?: boolean, fillColor?: string, color?: string, size?: number, stroke?: string, strokeWidth?: number }) => (
    <>
        {isFilled ?
            <svg
                height={size}
